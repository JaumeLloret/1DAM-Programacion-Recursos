# P6 · Ficheros, CSV/JSON y JavaFX

Biblioteca pública de **código, datos, starters y ejemplos** asociados a P6.
...
- Recursos públicos incluidos: **8**.
- Recursos omitidos por política de publicación segura: **24**.
