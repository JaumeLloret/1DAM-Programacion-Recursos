# P3 · Clases, objetos y encapsulación

Biblioteca pública de **código, datos, starters y ejemplos** asociados a P3.
...
- Recursos públicos incluidos: **19**.
- Recursos omitidos por política de publicación segura: **2**.
