# P8 · HTTP, API y contratos

Biblioteca pública de **código, datos, starters y ejemplos** asociados a P8.
...
- Recursos públicos incluidos: **4**.
- Recursos omitidos por política de publicación segura: **17**.
